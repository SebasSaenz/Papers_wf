...
# Select genomes for the phylogenetical analysis of key members of the rumen
...
# Create a vector with the more abundant DS families
sysfamily_list <- c(
  "Abi", "AVAST", "CBASS", "CRISPR-Cas", "DRT", "gabija",
  "Phosphorothioation", "Pycsar", "RM", "wadjet"
)

# Create files for key members of rumen ----------------------------------------
